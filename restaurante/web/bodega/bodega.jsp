                ...
                <div class="container">
                 <div class="row">
                   <div class="col-lg-2 col-md-3  col-3 offset-lg-3 offset-md-2 size">
                     <a type="submit" href="pedidos-cocina.jsp" class="btn-bodega btn btn-block">Cocina</a>
                   </div>
                   <div class="col-lg-2 col-md-3 col-3 size">
                     <a type="submit" href="crear-pedido.jsp" class="btn-bodega btn btn-block">+ Pedido</a>
                   </div>
                   <div class="col-lg-2 col-md-3 col-3 size ">
                      <a type="submit" href="crear-pedido.jsp" data-target="#exampleModalCenter"  data-toggle="modal" class="btn-bodega btn btn-block">+ Producto</a>
                   </div>
