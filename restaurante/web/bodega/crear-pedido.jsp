...
<div class="container-fluid caja-header">
  <div class="row align-items-center">
    <div class="col-lg-4 col-12">
      ...
      <div class="col-lg-8 col-12">
        ...
        <div class="row">
          <div class="col-lg-5 offset-lg-2 col-10 offset-1">
            <h4>Realizar solicitud de Insumos</h4>
          </div>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-2 offset-lg-9 col-3 offset-6">
       <a href="solicitudes.jsp"  class="btn-bodegab btn">Realizados</a>
      </div>
      <div class="col-lg-1 col-2 offset-1 offset-lg-0">
        <a href="bodega.jsp" class="btn"><i class="fas fa-home"></i></a>
      </div>
    </div>
    <!-- CONTENIDO -->
...
%>
        ...
        <form method="POST" action="../ServletPedProv">
             ...
             <td>
                 <button type="button"  id="botonpedido<%=menu%>" class="btn-bodega btn">Agregar</button>
             </td>
              <td>
...
%>
    ...
    <br>
    <div class="row ">
      <div class="col-lg-2 offset-lg-8 col-4 offset-4">
          <a href="bodega.jsp" class="btn-bodegacancelar btn">Cancelar</a>
      </div>
      <div class="col-lg-2  col-4">
          <button type="submit" value="Pendiente" name="estado" class="btn-bodegaaceptar btn">Enviar</button>
          </form>
      </div>
    </div>
