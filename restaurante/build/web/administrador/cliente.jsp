  ...
  <div class="container-fluid">
    ...
    <div class="row caja">
      <div class="col-3 offset-1">
        <a href="clientes.html"><h5 class="activos">CLIENTES</h5></a>
      </div>
      <div class="col-3">
        <a href="clientes-reserva.html"><h5 class="">RESERVAS</h5></a>
      </div>
    </div>
    ...
    <div class="row menu">
      <div class="col-11 offset-1">
       ...
       <th scope="col">Rut</th>
       <th scope="col">Compras/reservas</th>
       <th scope="col">Acciones</th>
        ...
        <tbody class="justify-content-center">
          <tr>
             ...
             <td>11.111.111-1</td>
             <td>
               <button type="submit" class="btn-caja btn">Ver</button>
             </td>
             <td>
    ...
    <div class="row ">
      <div class="col-lg-2 col-1 offset-1">
